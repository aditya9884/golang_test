...
Output Format
For each test case, output the number of kilometers Chef travels through office trips
 in a week.
 */
...
func main(){
	...
	for t > 0 {
		...
		var x int 
		fmt.Println("Enter the kilometer from home to office:")
		fmt.Scan(&x)

		a := (x * 2) * 5

		fmt.Println("The total kilometer travelled in week :",a)
